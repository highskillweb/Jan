...
<head>
  ...
  <title>Jan Moser - Senior PHP Developer</title>
            ...
            <div class="col-sm-12">
              <div class="home-inner">
                  <div class="center-align home-content">
                    <h1 class="home-title">HI! I'm <span>Jan Moser</span></h1>
                    <h2 class="home-subtitle">PHP Developer from Wroclaw, Poland</h2>
          ...
          <div class="clearfix about-inner">
            ...
            <div class="col-sm-6 col-md-4">
              <div class="person-info">
                ...
                <h5><span>Name :</span> Jan Moser</h5>
                <h5><span>Age :</span> 31 Years</h5>
                <h5><span>Email :</span> blackcomik@yandex.com</h5>
                <h5><span>Address :</span> Wroclaw, Poland</h5>
              </div>
                      ...
                      <div class="row">
                        <div id="experienceSlider" class="clearfix card-element-wrapper">
                          <div class="col-sm-4 cold-xs-12 single-card-box wow fadeInUpSmall" data-wow-duration=".7s">
                            <div class="card">
                              <div class="card-image waves-effect waves-block waves-light">
                                <h2 class="left-align card-title-top">March 2008 - September 2010</h2>
                                <div class="valign-wrapper card-img-wrap">
                                  <img class="activator" src="./images/exp1.jpg" alt="">
                                </div>
                              </div>
                              <div class="card-content">
                                <span class="card-title activator brand-text">PHP Developer<i class="mdi-navigation-more-vert right"></i></span>
                                <p>Metropolis Software</p>
                                <p>PHP, HTML, CSS</p>
                              </div>
                          ...
                          <div class="col-sm-4 cold-xs-12 single-card-box wow fadeInUpSmall" data-wow-delay=".2s" data-wow-duration=".7s">
                            <div class="card">
                              <div class="card-image waves-effect waves-block waves-light">
                                <h2 class="left-align card-title-top">November 2010 - February 2014</h2>
                                <div class="valign-wrapper card-img-wrap">
                          ...
                          <div class="col-sm-4 cold-xs-12 single-card-box wow fadeInUpSmall" data-wow-delay=".4s" data-wow-duration=".7s">
                            <div class="card">
                              ...
                              <div class="card-content">
                                <span class="card-title activator brand-text">Project Manager<i class="mdi-navigation-more-vert right"></i></span>
                                <p>CTL Logistics</p>
                      ...
                      <div class="row">
                        ...
                        <!-- single education -->
                          <div class="col-sm-4 single-card-box wow fadeInUpSmall" data-wow-duration=".7s">
                            <div class="card">
                              <div class="card-image waves-effect waves-block waves-light">
                                <h2 class="left-align card-title-top">2002 - 2006</h2>
                              ...
                              <div class="card-content">
                                ...
                                <p>Technical University of Wroclaw</p>
                              </div>
                              <!-- Reveal content-->
                            </div>
                          ...
                          <div class="col-sm-4 single-card-box wow fadeInUpSmall" data-wow-delay=".2s" data-wow-duration=".7s">
                            <div class="card">
                              <div class="card-image waves-effect waves-block waves-light">
                                <h2 class="left-align card-title-top">2006 - 2008</h2>
                                <div class="card-img-wrap">
                                  <img class="activator" src="./images/edu.jpg" alt="">
                                </div>
                              </div>
              ...
              <div class="row">
                <div class="clearfix section-head contact-text">
                  <div class="col-sm-12">
                    ...
                    <p class="regular-text">plac Uniwersytecki 1, 157 Wrocław</p>
                    <ul class="clearfix contact-info">
                      <li><a href="">Email: blackcomik@yandex.com</a>
                      </li>
                      <li><a href="">Skype: blackcomik</a>
                      </li>
                    </ul>
                  </div>
